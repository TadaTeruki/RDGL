...
var elevationList = []ColorElevation{
	MakeColorElevation(0.0, 0.0, 0.4, -10000),
	MakeColorElevation(0.05, 0.5, 0.9, -5000),
	...
	MakeColorElevation(0.75, 0.6, 0.25, 2000),
	MakeColorElevation(0.7, 0.5, 0.2, 3000),
	MakeColorElevation(0.7, 0.5, 0.2, 10000),
}
